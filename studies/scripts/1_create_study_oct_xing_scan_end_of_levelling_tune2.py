...
d_config_mad["optics_file"] = (
    "../../../../external_dependencies/acc-models-lhc-v13/opt_150_150_150_150_thin.madx"
)
...
for beam in ["lhcb1", "lhcb2"]:
    d_config_tune_and_chroma["qx"][beam] = 62.320
    d_config_tune_and_chroma["qy"][beam] = 60.325
...
# ==================================================================================================
# Define study name
study_name = "oct_xing_scan_end_of_levelling_tune2_corrected"
